...
btnFinish.addEventListener("click", () => {
    ...
    // Kiểm tra đáp án của người dùng theo type của câu hỏi
    questions.forEach((question, index) => {
        if (question.type === "single") {
            ...
            // Kiểm tra xem đáp án của người dùng có đúng không
            // Nếu đúng thì tăng điểm
            // Nếu sai thì không tăng điểm
            // let isCorrect = true;
            // question.answer.forEach(answer => {
            //     if (!yourAnswers[index].includes(answer)) {
            //         isCorrect = false;
            //     }
            // });
            // if (isCorrect) {
            ...
            const isCorrect = question.answer.every(answer => {
                return yourAnswers[index].includes(answer);
            });
            if (isCorrect) {
                score++;
            }
